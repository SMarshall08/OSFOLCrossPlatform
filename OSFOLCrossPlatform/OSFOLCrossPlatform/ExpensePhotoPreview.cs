...
namespace OSFOLCrossPlatform
{
    ...
    /// </summary>
    public class ExpensePhotoPreview : View
    {
        #region PictureTakenCommandProperty
        public static readonly BindableProperty PictureTakenCommandProperty =
            BindableProperty.Create<ExpensePhotoPreview, ICommand>(x => x.PictureTakenCommand, null);
        ...
        public void OnPictureTaken(Model.IImage image)
        {
    ...
    {
        public PictureTakenEventArgs(Model.IImage image)
        {
            Image = image;
        }

        public Model.IImage Image { get; private set; }
    }
}
